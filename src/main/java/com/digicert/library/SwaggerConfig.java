...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Scott Kingdon", "http://www.digicert.com",
			"scott.kingdon@gmail.com");

	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Library API", "Lbrary of books and authors", "1.0",
